...
// Fork of Zig stdlib `std.crypto.tls.Client` (Zig 0.15.2) with TLS 1.2
// `ECDHE_ECDSA_*` cipher suites enabled so we can connect to TLS 1.2 ECDSA-only
// hosts (e.g. news.ycombinator.com).
